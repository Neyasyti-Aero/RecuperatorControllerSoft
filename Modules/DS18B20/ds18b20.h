...
#define DS18B20_ROM_LEN_BYTES                                               8
...
typedef struct DS18B20
{
  ...
  uint8_t serialNumber[DS18B20_ROM_LEN_BYTES];
  int8_t temperatureLimitLow;
  int8_t temperatureLimitHigh;
...
extern DS18B20_Status DS18B20_WriteScratchpad(DS18B20 *sensor, int8_t *data);
...
extern void DS18B20_SetRom(DS18B20 *sensor, uint8_t* serialNumber);
